...
def get_data_3_0_5() -> dict:
    ...
    data = {
        # 数据更新时间
        'mtime': datetime.strptime('2024-10-08 08:51 +08:00', dtfmt),
        # 当前数据适用 Blender 版本范围
        'blender_vers': [
            ((3, 0, 0), _4__2__X_, None, None),
            # 开发版带有额外信息：提交日期、提交Hash（在 Blender 的关于窗口中可以看到）
            ((4, 3, 0), _4__3__X_, '2024-10-05 17:20', 'e82ce39e17f2'),
            ((4, 4, 0), _4__4__X_, '2024-10-05 20:11', '6d5d3ce975b5'),
        ],
        'items': {},
    }
