...
def get_data(ex_ver: tuple[int, int, int], bl_ver: tuple[int, int, int]) -> Union[dict, None]:
    ...
    if ex_ver <= (3, 0, 10):  # 从插件的 3.0.5 版才开始有该文件
        ...
        data['blender_vers'].extend([
            ...
            ((5, 0, 0), _5__0__X_, '2025-10-13 01:31 +08:00', '070344c06f6f'),
            ((5, 1, 0), _5__1__X_, '2025-10-17 12:14 +08:00', '829d2074a69f'),
        ])
...
def get_data_3_0_5() -> dict:
    ...
    data = {
        # 数据更新时间
        'mtime': datetime.strptime('2025-10-18 09:46 +08:00', dtfmt),
        # 当前数据适用 Blender 版本范围
        'blender_vers': [
