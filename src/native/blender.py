...
def get_data(ex_ver: tuple[int, int, int], bl_ver: tuple[int, int, int]) -> Union[dict, None]:
    ...
    if ex_ver <= (3, 0, 10):  # 从插件的 3.0.5 版才开始有该文件
        ...
        data['blender_vers'].extend([
            ...
            # ((5, 0, 0), _5__0__X_, None, None),
            ((3, 0, 0), _5__0__X_, None, None),
            # 开发版带有额外信息：提交日期、提交Hash（在 Git 的提交历史中可以看到）
            ((5, 1, 0), _5__1__X_, '2025-11-23 01:34 +08:00', '4961ed3befbd'),
        ])
...
def get_data_3_0_5() -> dict:
    ...
    data = {
        # 数据更新时间
        'mtime': datetime.strptime('2026-03-04 18:00 +08:00', dtfmt),
        # 当前数据适用 Blender 版本范围
        'blender_vers': [
    ...
    if _ex_ver >= (3, 0, 13):  # 从 Blender 4.5.0 开始需要该参数
