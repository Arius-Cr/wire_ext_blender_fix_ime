...
def get_data_3_0_5() -> dict:
    ...
    data = {
        # 数据更新时间
        'mtime': datetime.strptime('2024-06-15 09:15 +08:00', dtfmt),
        # 当前数据适用 Blender 版本范围
        'blender_vers': [
            ((3, 0, 0), _3__6__X_, None, None),
            ((4, 0, 0), _4__1__X_, None, None),
            # 开发版带有额外信息：提交日期、提交Hash（在 Blender 的关于窗口中可以看到）
            ((4, 2, A), (4, 2, A), '2024-06-14 22:44', '9266fbab0276'),
            ((4, 3, A), (4, 3, A), '2024-06-13 19:22', 'c810d1413df7'),
        ],
        'items': {},
    }
    ...
    MAP(items, 'sizeof_uiHandleButtonData', [
        ...
        ((4, 3, A), (4, 3, A), 360),  # 开发版 uiHandleButtonData 总有差异，需要通过调试信息确定大小
    ])
    ...
    MAP(items, 'offset_uiBlock__buttons', [
        ...
        ((4, 3, A), (4, 3, A), 16),  # 开发版 uiBlock 总有差异，但不影响 buttons 成员
    ])
    ...
    MAP(items, 'offset_uiBut__flag', [
        ...
        ((4, 3, A), (4, 3, A), 24),  # 开发版 uiBut 总有差异，但不影响 flag 成员
    ])
    ...
    MAP(items, 'offset_uiBut__type', [
        ...
        ((4, 3, A), (4, 3, A), 36),  # 开发版 uiBut 总有差异，但不影响 type 成员
    ])
