...
A = 0
Z = 99
_3__6__X_ = (3, 6, Z)  # 人工核对偏移量的最后一个版本为 3.6.14 ，之后均假设偏移量没有变动
_4__2__X_ = (4, 2, Z)  # 人工核对偏移量的最后一个版本为 4.2.0  ，之后均假设偏移量没有变动
_4__3__X_ = (4, 3, Z)  # 人工核对偏移量的最后一个版本为 4.3.0  ，之后均假设偏移量没有变动
_4__4__X_ = (4, 4, Z)  # 人工核对偏移量的最后一个版本为 4.4.0  ，之后均假设偏移量没有变动
_4__5__X_ = (4, 5, Z)  # 人工核对偏移量的最后一个版本为 4.5.0  ，之后均假设偏移量没有变动
_5__0__X_ = (5, 0, Z)  # 人工核对偏移量的最后一个版本为 5.0.0  ，之后均假设偏移量没有变动
_5__1__X_ = (5, 1, Z)  # 人工核对偏移量的最后一个版本为 5.1.0  ，之后均假设偏移量没有变动
...
def get_data(ex_ver: tuple[int, int, int], bl_ver: tuple[int, int, int]) -> Union[dict, None]:
    ...
    if ex_ver >= (3, 0, 23):
        # 3.0.23 - 3.0.23，支持 3.0.0 - 5.1.0
        data = get_data_3_0_5()
        data['blender_vers'].extend([
            ((3, 0, 0), _5__1__X_, None, None),
        ])
    elif ex_ver >= (3, 0, 22):
        # 3.0.22 - 3.0.22 支持 3.0.0 - 5.0.0
        data = get_data_3_0_5()
        data['blender_vers'].extend([
            ((3, 0, 0), _5__0__X_, None, None),
        ])
    elif ex_ver >= (3, 0, 13):
        # 3.0.13 - 3.0.21 支持 3.0.0 - 4.5.0
        data = get_data_3_0_5()
        data['blender_vers'].extend([
            ((3, 0, 0), _4__5__X_, None, None),
        ])
    elif ex_ver >= (3, 0, 11):
        # 3.0.11 - 3.0.12 支持 3.0.0 - 4.4.0
        data = get_data_3_0_5()
        data['blender_vers'].extend([
            ((3, 0, 0), _4__4__X_, None, None),
        ])
    else:
        # 3.0.5 - 3.0.10 支持 3.0.0 - 4.3.0
        # 从插件的 3.0.5 版才开始有该文件
        data = get_data_3_0_5()
        data['blender_vers'].extend([
...
def get_data_3_0_5() -> dict:
    ...
    data = {
        # 数据更新时间
        'mtime': datetime.strptime('2026-03-19 00:00 +08:00', dtfmt),
        # 当前数据适用 Blender 版本范围
        'blender_vers': [
    ...
    if _ex_ver >= (3, 0, 23):  # 需要 3.0.23 及以上的插件才支持
    ...
    if _ex_ver >= (3, 0, 11):  # 需要 3.0.11 及以上的插件才支持
    ...
    if _ex_ver >= (3, 0, 22):  # 需要 3.0.22 及以上的插件才支持
    ...
    if _ex_ver >= (3, 0, 13):  # 需要 3.0.13 及以上的插件才支持，从 Blender 4.5.0 开始需要该参数
    ...
    if _ex_ver >= (3, 0, 22):  # 需要 3.0.22 及以上的插件才支持
        MAP(items, 'UI_BTYPE_NUM_SLIDER', [
            ((3, 0, 0), _3__6__X_, (7 << 9)),  # V1
            ((4, 0, 0), _4__4__X_, (7 << 9)),  # V1
    ...
    if _ex_ver >= (3, 0, 14):  # 需要 3.0.14 及以上的插件才支持
