...
_4__5__X_ = (4, 5, 99)  # 人工核对偏移量的最后一个版本为 4.5.0  ，之后均假设偏移量没有变动
...
def get_data(ex_ver: tuple[int, int, int], bl_ver: tuple[int, int, int]) -> Union[dict, None]:
    ...
    if ex_ver <= (3, 0, 10):  # 从插件的 3.0.5 版才开始有该文件
        ...
        data['blender_vers'].extend([
            ...
            ((5, 0, 0), _5__0__X_, '2025-07-25 22:12', 'ed372380c54f'),
        ])
...
def get_data_3_0_5() -> dict:
    ...
    data = {
        # 数据更新时间
        'mtime': datetime.strptime('2025-07-26 15:46 +08:00', dtfmt),
        # 当前数据适用 Blender 版本范围
        'blender_vers': [
    ...
    MAP(items, 'offset_uiBut__flag', [
        ...
        ((4, 5, 0), _4__5__X_, 16),  # V11
        ((5, 0, 0), _5__0__X_, 16),  # V12
    ])
    ...
    MAP(items, 'offset_uiBut__type', [
        ...
        ((4, 5, 0), _4__5__X_, 28),  # V11
        ((5, 0, 0), _5__0__X_, 25),  # V12
    ])

    MAP(items, 'UI_SELECT', [
        ((3, 0, 0), _3__6__X_, (1 << 0)),  # V1
        ((4, 0, 0), _4__4__X_, (1 << 0)),  # V1
        ((4, 5, 0), _4__5__X_, (1 << 0)),  # V1
        ((5, 0, 0), _5__0__X_, 1),  # V2
    ])  # 十六进制：   1，( 1 << 0)

    MAP(items, 'UI_BTYPE_TEXT', [
        ((3, 0, 0), _3__6__X_, (3 << 9)),  # V1
        ((4, 0, 0), _4__4__X_, (3 << 9)),  # V1
        ((4, 5, 0), _4__5__X_, (3 << 9)),  # V1
        ((5, 0, 0), _5__0__X_, 3),  # V2
    ])  # 十六进制： 600，( 3 << 9)

    MAP(items, 'UI_BTYPE_NUM', [
        ((3, 0, 0), _3__6__X_, (6 << 9)),  # V1
        ((4, 0, 0), _4__4__X_, (6 << 9)),  # V1
        ((4, 5, 0), _4__5__X_, (6 << 9)),  # V1
        ((5, 0, 0), _5__0__X_, 6),  # V2
    ])  # 十六进制： C00，( 6 << 9)

    MAP(items, 'UI_BTYPE_SEARCH_MENU', [
        ((3, 0, 0), _3__6__X_, (41 << 9)),  # V1
        ((4, 0, 0), _4__4__X_, (41 << 9)),  # V1
        ((4, 5, 0), _4__5__X_, (41 << 9)),  # V1
        ((5, 0, 0), _5__0__X_, 33),  # V2
    ])  # 十六进制：5200，(41 << 9)
